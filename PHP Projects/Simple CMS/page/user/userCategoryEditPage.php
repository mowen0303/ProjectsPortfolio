...
<?php require_once $_SERVER["DOCUMENT_ROOT"]. "/a2/page/frame/top.php"; ?>
    ...
    <section class="cmsConSection cmsConSectionWhite">
        ...
        <?php foreach($RIGHT as $k=>$v){ ?>
            <P><label><input type="checkbox" name="authority[]" value="<?php echo $v?>" <?php echo $userCategoryRow['user_category_authority']&$v?'checked':null ?> ><?php echo $k?></label></P>
        <?php } ?>
